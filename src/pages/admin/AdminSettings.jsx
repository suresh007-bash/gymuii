        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))', gap: 12 }}>
              {Object.entries(THEME_PRESETS).map(([key, preset]) => (
                ...
                >
                  ...
                  {activePreset === key && (
                    <div style={{ fontSize: 10, fontWeight: 800, color: preset.primary, marginTop: 4 }}>✓ ACTIVE</div>
                  )}
                </div>
              ))}
            </div>
          ...
          <div className="card">
              ...
              <div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  <input className="form-input" value={themePrimary} onChange={e => setThemePrimary(e.target.value)}
                    style={{ width: 100, fontFamily: 'monospace', fontSize: 13, fontWeight: 700 }} />
                </div>
              </div>
              <div>
            ...
            <div style={{
              ...
              <div style={{ fontSize: 11, fontWeight: 700, color: 'var(--text-muted)', marginBottom: 8 }}>LIVE PREVIEW</div>
              <div style={{ display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
                <div style={{
                  padding: '8px 20px', borderRadius: 10, fontWeight: 700, fontSize: 13, color: '#fff',
                ...
                <div style={{
                  padding: '4px 14px', borderRadius: 20, fontSize: 11, fontWeight: 800, letterSpacing: 1,
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                  <div>
                    <span style={{ fontSize: 10, color: 'var(--text-muted)', fontWeight: 600 }}>Color 1</span>
                  ...
                  <div>
                    <span style={{ fontSize: 10, color: 'var(--text-muted)', fontWeight: 600 }}>Color 2</span>
              ...
              <div style={{
                ...
                <p style={{ fontSize: 11, opacity: 0.65, maxWidth: 350, lineHeight: 1.6 }}>
