    ...
    <DashboardLayout title="Trainer Profile">
      <div style={{ maxWidth: 600, margin: '0 auto' }}>
        <div className="card" style={{ textAlign: 'center', padding: 32, marginBottom: 20 }}>
          ...
          <p style={{ color: 'var(--accent-orange)', fontSize: 'clamp(12px, 3vw, 17px)', fontWeight: 700 }}>{user?.specialization}</p>
          <p style={{ color: 'var(--text-muted)', fontSize: 'clamp(12px, 3vw, 16px)' }}>{user?.certifications}</p>
        </div>
