      ...
      <div className="card" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          <div style={{
            ...
            fontSize: 'calc(32px + 0.5vw)', boxShadow: '0 6px 20px rgba(249,115,22,0.3)',
          }}></div>
          <div>
            <h3 style={{ fontFamily: 'Outfit', fontWeight: 800, fontSize: 'calc(24px + 0.5vw)', marginBottom: 4 }}>
              Find Your Perfect Gym
            </h3>
            <p style={{ color: 'var(--text-muted)', fontSize: 'calc(17px + 0.5vw)', lineHeight: 1.5 }}>
          ...
          >
            ...
            <div style={{ position: 'relative', height: 180, overflow: 'hidden' }}>
              ...
              <div style={{
                ...
                color: '#fff', fontSize: 'calc(16px + 0.5vw)', fontWeight: 700,
              ...
              <div style={{
                ...
                color: '#fff', fontSize: 'calc(15px + 0.5vw)', fontWeight: 600,
                display: 'flex', alignItems: 'center', gap: 4,
              }}>
                 {gym.location}
              </div>
            ...
            <div style={{ padding: '16px 18px 18px' }}>
              <h4 style={{ fontFamily: 'Outfit', fontWeight: 800, fontSize: 'calc(21px + 0.5vw)', marginBottom: 10 }}>
                {gym.name}
              </h4>
              ...
              <div style={{ display: 'flex', gap: 12, marginBottom: 14 }}>
                <div style={{
                  ...
                  fontSize: 'calc(16px + 0.5vw)', color: 'var(--text-muted)', fontWeight: 600,
                }}>
                   {gym.members} members
                </div>
                <div style={{
              ...
              <div style={{
                ...
                <div>
                  <span style={{ fontSize: 'calc(15px + 0.5vw)', color: 'var(--text-muted)', fontWeight: 600 }}>From </span>
                  <span style={{
                    fontFamily: 'Outfit', fontWeight: 800, fontSize: 'calc(21px + 0.5vw)',
                    background: 'linear-gradient(135deg, #f97316, #fb923c)',
                    WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent',
                  }}>₹1,000</span>
                  <span style={{ fontSize: 'calc(15px + 0.5vw)', color: 'var(--text-muted)', fontWeight: 600 }}>/mo</span>
                </div>
                <button
                  ...
                  style={{
                    ...
                    fontSize: 'calc(16px + 0.5vw)', padding: '8px 16px', borderRadius: 10,
                  }}
      ...
      <div style={{ maxWidth: 700, margin: '0 auto' }}>
        ...
        <button
          ...
          style={{
            ...
            color: 'var(--text-muted)', fontSize: 'calc(17px + 0.5vw)', fontWeight: 700,
          ...
          <div style={{ position: 'relative', height: 260, overflow: 'hidden' }}>
            ...
            <button
              ...
              style={{
                ...
                border: 'none', cursor: 'pointer', color: '#fff', fontSize: 'calc(20px + 0.5vw)',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
        ...
        <div className="card" style={{ marginBottom: 16 }}>
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 12 }}>
            <div>
              <h2 style={{ fontFamily: 'Outfit', fontWeight: 900, fontSize: 'calc(26px + 0.5vw)', marginBottom: 6 }}>
                {selectedGym.name}
              </h2>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
                <span style={{ fontSize: 'calc(17px + 0.5vw)', color: 'var(--text-muted)', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 4 }}>
          ...
          <div style={{
            ...
            background: 'var(--bg-tertiary)', fontSize: 'calc(16px + 0.5vw)', color: 'var(--text-muted)', fontWeight: 600,
          }}>
             {selectedGym.hours}
          </div>
        </div>
        ...
        {/* About */}
        <div className="card" style={{ marginBottom: 16 }}>
          <h4 style={{ fontFamily: 'Outfit', fontWeight: 800, fontSize: 'calc(19px + 0.5vw)', marginBottom: 10, display: 'flex', alignItems: 'center', gap: 8 }}>
             About
          </h4>
          <p style={{ fontSize: 'calc(17px + 0.5vw)', lineHeight: 1.7, color: 'var(--text-secondary)' }}>
        ...
        {/* Amenities */}
        <div className="card" style={{ marginBottom: 16 }}>
          <h4 style={{ fontFamily: 'Outfit', fontWeight: 800, fontSize: 'calc(19px + 0.5vw)', marginBottom: 14, display: 'flex', alignItems: 'center', gap: 8 }}>
             Amenities
          </h4>
            ...
            {selectedGym.amenities.map((a, i) => (
              <div
                ...
                style={{
                  ...
                  fontSize: 'calc(16px + 0.5vw)', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 6,
                ...
                >
                  {plan.popular && (
                    <div style={{
                      ...
                      padding: '3px 12px', borderRadius: 20, fontSize: 'calc(13px + 0.5vw)', fontWeight: 800,
                      background: 'linear-gradient(135deg, #f97316, #fb923c)',
                  ...
                  <div style={{ fontSize: 'calc(17px + 0.5vw)', fontWeight: 700, marginBottom: 8, color: 'var(--text-secondary)' }}>
                    {plan.name}
                  </div>
                  <div style={{
                    fontFamily: 'Outfit', fontWeight: 900, fontSize: 'calc(28px + 0.5vw)', marginBottom: 4,
                  ...
                  <div style={{ fontSize: 'calc(15px + 0.5vw)', color: 'var(--text-muted)', fontWeight: 600 }}>
                    {plan.duration}
                  </div>
                  {isSelected && (
                    <div style={{
                      marginTop: 10, fontSize: 'calc(14px + 0.5vw)', fontWeight: 700,
              ...
              {gymTrainers.map(trainer => (
                <div key={trainer.id} style={{
                  ...
                  <div style={{
                    ...
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    fontSize: 'calc(19px + 0.5vw)', fontWeight: 800, color: '#fff',
                    boxShadow: '0 4px 12px rgba(99,102,241,0.25)',
                  }}>{trainer.avatar}</div>
                  <div style={{ flex: 1 }}>
                    <div style={{ fontWeight: 800, fontSize: 'calc(18px + 0.5vw)' }}>{trainer.name}</div>
                    <div style={{ fontSize: 'calc(16px + 0.5vw)', color: 'var(--text-muted)', fontWeight: 600 }}>
                      {trainer.specialization}
                    </div>
                  </div>
                  <span className="badge badge-purple" style={{ fontSize: 'calc(14px + 0.5vw)' }}>Trainer</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <button
          ...
          style={{
            ...
            fontFamily: 'Outfit', fontWeight: 800, fontSize: 'calc(20px + 0.5vw)', cursor: selectedPlan ? 'pointer' : 'not-allowed',
    ...
    if (!gym) {
      return (
        <div style={{ maxWidth: 600, margin: '0 auto', textAlign: 'center', padding: 40 }}>
          <div style={{ fontSize: 'calc(60px + 0.5vw)', marginBottom: 16 }}></div>
          <h3 style={{ fontFamily: 'Outfit', fontWeight: 800, fontSize: 'calc(24px + 0.5vw)', marginBottom: 8 }}>No Gym Yet</h3>
          <p style={{ color: 'var(--text-muted)', fontSize: 'calc(17px + 0.5vw)', marginBottom: 20 }}>Browse and join a gym to get started!</p>
          ...
          <div style={{ position: 'relative', height: 200, overflow: 'hidden' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                fontSize: 'calc(14px + 0.5vw)', fontWeight: 800, letterSpacing: 0.5, marginBottom: 8,
                textTransform: 'uppercase',
              }}> Your Current Gym</div>
              <h2 style={{ fontFamily: 'Outfit', fontWeight: 900, fontSize: 'calc(26px + 0.5vw)', color: '#fff', marginBottom: 4 }}>
                {gym.name}
              </h2>
              <div style={{ fontSize: 'calc(17px + 0.5vw)', color: 'rgba(255,255,255,0.8)', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          <div style={{ padding: '16px 20px' }}>
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontSize: 'calc(22px + 0.5vw)', fontWeight: 800 }}> {gym.members}</div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: 'calc(22px + 0.5vw)', fontWeight: 800 }}>️ {gym.trainers}</div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: 'calc(22px + 0.5vw)', fontWeight: 800 }}> {gym.rating}</div>
                <div style={{ fontSize: 'calc(14px + 0.5vw)', color: 'var(--text-muted)', fontWeight: 600 }}>Rating</div>
              </div>
            </div>
            <div style={{
              padding: '8px 14px', borderRadius: 10,
              background: 'var(--bg-tertiary)', fontSize: 'calc(16px + 0.5vw)',
              ...
              {gymTrainers.map((trainer, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ fontWeight: 800, fontSize: 'calc(18px + 0.5vw)', marginBottom: 2 }}>
                        {trainer.name}
                        {isMyTrainer && (
                          <span style={{
                            marginLeft: 8, fontSize: 'calc(14px + 0.5vw)', fontWeight: 700, color: '#22c55e',
                          }}> Your Trainer</span>
                        )}
                      </div>
                      <div style={{ fontSize: 'calc(16px + 0.5vw)', color: 'var(--text-muted)', fontWeight: 600, marginBottom: 4 }}>
                        {trainer.specialization}
                      </div>
                      <div style={{ display: 'flex', gap: 12, fontSize: 'calc(15px + 0.5vw)', color: 'var(--text-muted)' }}>
                    ...
                    {isMyTrainer ? (
                      <div style={{
                        ...
                        color: '#22c55e', fontWeight: 700, fontSize: 'calc(15px + 0.5vw)', whiteSpace: 'nowrap',
                      }}>
                         Hired
                      </div>
                    ) : (
                      <button
                        ...
                        style={{
                          ...
                          background: 'linear-gradient(135deg, #6366f1, #8b5cf6)',
                          color: '#fff', fontWeight: 700, fontSize: 'calc(15px + 0.5vw)', cursor: 'pointer',
        ...
        <div className="modal-content" onClick={e => e.stopPropagation()} style={{ maxWidth: 440 }}>
          ...
          <div style={{ padding: '8px 0 16px' }}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: 'calc(16px + 0.5vw)', color: 'var(--text-muted)', fontWeight: 600, marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.5 }}>
                Joining
              </div>
              <div style={{ fontFamily: 'Outfit', fontWeight: 800, fontSize: 'calc(20px + 0.5vw)', marginBottom: 2 }}>
                {selectedGym.name}
              </div>
              <div style={{ fontSize: 'calc(16px + 0.5vw)', color: 'var(--text-muted)', fontWeight: 600 }}>
                 {selectedGym.location}
              ...
              <div style={{
                ...
                <span style={{ fontSize: 'calc(17px + 0.5vw)', fontWeight: 700 }}>{selectedPlan.name} Plan ({selectedPlan.duration})</span>
                <span style={{
                  fontFamily: 'Outfit', fontWeight: 900, fontSize: 'calc(24px + 0.5vw)',
                  background: 'linear-gradient(135deg, #f97316, #fb923c)',
                  WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent',
            ...
            <div style={{ marginBottom: 20 }}>
              <div style={{ fontSize: 'calc(16px + 0.5vw)', fontWeight: 700, color: 'var(--text-muted)', marginBottom: 10, textTransform: 'uppercase', letterSpacing: 0.5 }}>
                Payment Method
              </div>
              <div style={{ display: 'flex', gap: 10 }}>
                {paymentMethods.map(m => (
                  ...
                  >
                    <div style={{ fontSize: 'calc(26px + 0.5vw)', marginBottom: 4 }}>{m.icon}</div>
                    <div style={{ fontSize: 'calc(15px + 0.5vw)', fontWeight: 700, color: paymentMethod === m.key ? '#f97316' : 'var(--text-secondary)' }}>
                      {m.label}
                    </div>
                  </button>
                ))}
          ...
          <div style={{ padding: '8px 0 16px' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                background: 'linear-gradient(135deg, #6366f1, #8b5cf6)',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                fontSize: 'calc(26px + 0.5vw)', fontWeight: 800, color: '#fff',
                boxShadow: '0 6px 20px rgba(99,102,241,0.3)',
              }}>
                {selectedTrainer.avatar}
              </div>
              <h3 style={{ fontWeight: 800, fontSize: 'calc(21px + 0.5vw)', marginBottom: 4 }}>{selectedTrainer.name}</h3>
              <p style={{ color: 'var(--text-muted)', fontSize: 'calc(17px + 0.5vw)' }}>{selectedTrainer.specialization}</p>
            </div>
            ...
            <div style={{
              ...
              <span style={{ fontSize: 'calc(17px + 0.5vw)', fontWeight: 700 }}>Personal Training (Monthly)</span>
              <span style={{
                fontFamily: 'Outfit', fontWeight: 900, fontSize: 'calc(24px + 0.5vw)',
                background: 'linear-gradient(135deg, #6366f1, #8b5cf6)',
                WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent',
            ...
            <div style={{ marginBottom: 8 }}>
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                {paymentMethods.map(m => (
                  ...
                  >
                    <div style={{ fontSize: 'calc(26px + 0.5vw)', marginBottom: 4 }}>{m.icon}</div>
                    <div style={{ fontSize: 'calc(15px + 0.5vw)', fontWeight: 700, color: paymentMethod === m.key ? '#6366f1' : 'var(--text-secondary)' }}>
                      {m.label}
                    </div>
                  </button>
                ))}
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                fontWeight: 700, fontSize: 'calc(17px + 0.5vw)', cursor: 'pointer',
