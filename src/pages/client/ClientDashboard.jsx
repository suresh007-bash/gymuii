...
import { Icon, Utensils, Flame, Clock, Sun } from '../../components/Icons';
    ...
    <DashboardLayout title="Dashboard">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 250px), 1fr))', gap: 16, marginBottom: 20 }}>
        <div className="card" style={{ borderLeft: '4px solid #f97316' }}>
          <h4 style={{ fontWeight: 800, fontSize: 14, marginBottom: 6, display: 'flex', alignItems: 'center', gap: 6 }}><Clock size={14} color="#f97316" /> Breakfast order timing</h4>
        ...
        <div className="card" style={{ borderLeft: '4px solid #22c55e' }}>
          <h4 style={{ fontWeight: 800, fontSize: 14, marginBottom: 6, display: 'flex', alignItems: 'center', gap: 6 }}><Sun size={14} color="#22c55e" /> Lunch order timing</h4>
