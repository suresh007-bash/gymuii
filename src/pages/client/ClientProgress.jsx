    ...
    <DashboardLayout title="Progress Analytics">
      ...
      {tab === 'overview' && (<>
        ...
        <div className="card" style={{ marginBottom: 20 }}>
          <div className="card-header"><h3 className="card-title" style={{display:'flex',alignItems:'center',gap:6}}><Flame size={16} color="#f97316" /> Weekly Calorie Intake</h3><span style={{ fontSize: 12, color: 'var(--text-muted)' }}>Target: {calTarget} kcal/day</span></div>
        ...
        {/* Protein Chart */}
        <div className="card">
          <div className="card-header"><h3 className="card-title" style={{display:'flex',alignItems:'center',gap:6}}><Beef size={16} color="#22c55e" /> Weekly Protein Intake</h3><span style={{ fontSize: 12, color: 'var(--text-muted)' }}>Target: {proTarget}g/day</span></div>
        ...
        <div>
          <div className="card" style={{ marginBottom: 20 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 20, padding: 16 }}>
              <div style={{ width: 80, height: 80, borderRadius: '50%', background: 'var(--gradient-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 32 }}><Target size={32} color="#fff" /></div>
              <div>
