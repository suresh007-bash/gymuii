...
export default function RegisterPage() {
  ...
  const inputStyle = {
    ...
    borderRadius: 12, color: '#fff', fontSize: 'var(--fs-xs)', outline: 'none', transition: 'border 0.3s',
  };
  const labelStyle = {
    ...
    <div style={{ minHeight: '112vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: 480, width: '100%', animation: 'scaleIn 0.5s cubic-bezier(0.16,1,0.3,1)', position: 'relative', zIndex: 10 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: 'var(--fs-xs)' }}>
        ...
        <div style={{
          ...
          {step === 1 && (
            <p style={{ textAlign: 'center', color: 'rgba(255,255,255,0.4)', fontSize: 'var(--fs-xs)', marginTop: 16 }}>Already have an account? <Link to="/login" style={{ color: '#f97316', fontWeight: 700 }}>Sign In</Link></p>
          )}
        </div>
      </div>
    </div>
